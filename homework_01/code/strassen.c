...
void opt_strassen_aux(float **C, const size_t C_f_row, const size_t C_f_col,
               float **A, const size_t A_f_row, const size_t A_f_col,
               float **B, const size_t B_f_row, const size_t B_f_col,
               const size_t n,
               float **U, const size_t U_f_row, const size_t U_f_col)
{
  if (n < (1<<6)) {
    naive_aux(C, C_f_row, C_f_col,
              A, A_f_row, A_f_col,
  ...
  const size_t U1X = U_f_row;
  const size_t U2X = U_f_row + n2;
  const size_t UX1 = U_f_col;
  const size_t UX2 = U_f_col + n2;
  ...
  // S9 = A11 - A21
  sub_matrix_blocks(U,U1X,UX1,
                    A,A1X,AX1,
                    A,A2X,AX1,
                    n2);

  // S10 = B11 + B12
  sum_matrix_blocks(U,U1X,UX2,
                    B,B1X,BX1,
                    B,B1X,BX2,
                    n2);
...
void opt_strassen(float **C,
      float **A, float **B, const size_t n)
{

  float** U = allocate_matrix(n,n);
  opt_strassen_aux(C, 0, 0, A, 0, 0, B, 0, 0, n, U, 0, 0);
